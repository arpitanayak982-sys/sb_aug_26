...
public class HelloController {
  @RequestMapping("/home")//annotation
  public void sayHello(PrintWriter writer) {//method sayhello
    System.out.println("Hello Web");
    writer.println("<h1>Hello Spring Web</h1> <p>Welcome Home</P>");//writer.println method
  }
  ...
  public String contact() {//RETurn type string
    return "contact-page";
  }
